    ...
    <div className="w-full max-w-sm overflow-hidden rounded-2xl border border-border/50 bg-card shadow-float">
      <div className="border-b border-border/30 px-8 pt-8 pb-6 text-center">
        ...
        <p className="mt-1 text-[13px] text-muted-foreground/60">
          {bootstrapMode ? 'Create your admin account to get started' : 'Sign in to your workspace'}
        </p>
      </div>
      ...
      <div className="p-8">
        ...
        {bootstrapMode && (
          <p className="mt-4 text-center text-[11px] leading-relaxed text-muted-foreground/50">
            ...
            <code className="rounded-md border border-border/40 bg-muted/30 px-1 py-0.5 text-[10px]">ALLOW_BOOTSTRAP=true</code> from your env after setup.
          </p>
        )}
      </div>
    </div>
