...
export function CustomerScreen({ customers, canWrite }: Props) {
  ...
  return (
    <div className="mx-auto max-w-5xl flex flex-col gap-4">
      ...
      <div>
        <input type="search" placeholder="Search customers…" value={search} onChange={e => setSearch(e.target.value)} className="w-full max-w-sm rounded-lg border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-400" />
      </div>
