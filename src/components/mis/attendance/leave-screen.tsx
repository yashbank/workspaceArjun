...
export function LeaveScreen({ leaves, employees, canApprove, initialEmployeeId }: Props) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-5 py-6">
      ...
      <div>
        <input type="search" placeholder="Search by employee…" value={empSearch} onChange={e => setEmpSearch(e.target.value)} className="w-full max-w-sm rounded-lg border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-400" />
      </div>
